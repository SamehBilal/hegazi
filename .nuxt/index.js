...
import nuxt_plugin_plugin_a3fe2636 from 'nuxt_plugin_plugin_a3fe2636' // Source: .\\components\\plugin.js (mode: 'all')
import nuxt_plugin_vuescrollto_606fe6fe from 'nuxt_plugin_vuescrollto_606fe6fe' // Source: .\\vue-scrollto.js (mode: 'client')
...
async function createApp(ssrContext, config = {}) {
  ...
  if (typeof nuxt_plugin_plugin_a3fe2636 === 'function') {
    await nuxt_plugin_plugin_a3fe2636(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_vuescrollto_606fe6fe === 'function') {
    await nuxt_plugin_vuescrollto_606fe6fe(app.context, inject)
  }

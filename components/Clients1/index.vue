      ...
      <div class="row">
        <div class="col-lg-4 valign md-mb50">
          <div class="sec-head mb-0">
            <h6 class="wow fadeIn" data-wow-delay=".5s">Brands</h6>
            <h3 class="wow mb-20 color-font">My Clients</h3>
            <p>
              Brands i've worked with.<with class=""></with>
            </p>
          </div>
        </div>
        <div class="col-lg-8">
          <div>
            <div class="row bord">
              <div
                v-for="item in clientsData.slice(0, clientsData.length / 3)"
                :key="item.id"

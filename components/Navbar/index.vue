          ...
          <li class="nav-item">
           ...
           <li class="nav-item dropdown" @click="handleDropdown">
            ...
            <div class="dropdown-menu">
              ...
              <NuxtLink class="dropdown-item" to="works/motion-graphics">
                Motion Graphics
              </NuxtLink>
              <NuxtLink class="dropdown-item" to="works/videography-and-video-editing">
                Videography & Video Editing
              </NuxtLink>
              <NuxtLink class="dropdown-item" to="works/photography">
                Photography
              </NuxtLink>
              <NuxtLink class="dropdown-item" to="works/live-streams">
                Live Streams
              </NuxtLink>
            </div>
          </li>
